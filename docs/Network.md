# Network
## Overview
Moss Network slightly modified version of ENet6 v6.1.2. ENet6 is a reliable networking library built on top of Enet, enabling both connection-oriented and connectionless communication with low overhead suorting both IPv4 and IPv6.
...
enum ENetPacketFlag {
    ...
    ENET_PACKET_FLAG_NO_ALLOCATE = (1 << 2),         // Packet will not allocate data, and user must suly it instead */
...
ENetPacket * packet = enet_packet_create ("packet", 
    ...
    /* Extend the packet so and aend the string "foo", so it now */
